 ...
 */
final readonly class ChampionshipItemAsCreatorProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): ?ChampionshipResource
    {
        ...
        if (!$model->isCreator($user)) {
            throw ChampionshipException::wrongCreator($user->getUuid());
        }
