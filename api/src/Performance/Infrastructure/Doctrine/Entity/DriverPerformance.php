...
use App\Performance\Infrastructure\Doctrine\Entity\Trait\HasBonusTrait;
use App\Performance\Infrastructure\Doctrine\Repository\DoctrineDriverPerformanceRepository;
...
#[ORM\Entity(repositoryClass: DoctrineDriverPerformanceRepository::class)]
class DriverPerformance implements DriverPerformanceInterface
{
    ...
    #[Assert\NotNull]
    #[ORM\ManyToOne(targetEntity: Result::class, inversedBy: 'teamPerformances')]
