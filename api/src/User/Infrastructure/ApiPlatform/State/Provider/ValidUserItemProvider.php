...
use App\User\Application\Query\Get\GetUserVisitorByEmailValidationTokenQuery;
use App\User\Infrastructure\ApiPlatform\Resource\UserResource;

/**
 * @implements ProviderInterface<UserResource>
 */
final readonly class ValidUserItemProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): ?UserResource
    {
        ...
        $model = $this->queryBus->ask(new GetUserVisitorByEmailValidationTokenQuery($token));
