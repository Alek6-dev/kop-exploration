...
use App\Notification\Application\Command\MarkAllNotificationsRead\MarkAllNotificationsReadCommand;
...
final readonly class MarkAllNotificationsReadProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): void
    {
        ...
        $this->commandBus->dispatch(new MarkAllNotificationsReadCommand(
            user: $user,
        ));
    }
}
